...
public class GPApplicationContext {
    ...
    // the cache of the beanName and  the non-proxied Bean mappings
    ...
    private void doRegistBeanDefinition(List<GPBeanDefinition> beanDefinitions) throws Exception {
        for (GPBeanDefinition beanDefinition : beanDefinitions) {
            if (this.beanDefinitionMap.containsKey(beanDefinition.getFactoryBeanName())) {
                System.out.println("Bean Name: "+ beanDefinition.getFactoryBeanName() + "already exists");
...
//            beanDefinitionMap.put(beanDefinition.getBeanClassName(), beanDefinition);
    ...
    public Object getBean(String beanName) {
        ...
        GPBeanWrapper beanWrapper = factoryBeanInstanceCache.get(beanName);
        if (beanWrapper != null) {
        ...
        beanWrapper = new GPBeanWrapper(instance);
    ...
    private Object instantiateBean(String beanName, GPBeanDefinition beanDefinition) {
        ...
        try {
            ...
            //Cache non-proxied bean instance
